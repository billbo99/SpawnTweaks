data:extend(
    {
        ...
        { name = "SpawnTweaks-gun_base_multiplyer", type = "int-setting", default_value = 15, setting_type = "runtime-global", order = "0100" },
        { name = "SpawnTweaks-ammo_base_multiplyer", type = "int-setting", default_value = 50, setting_type = "runtime-global", order = "0150" },
        { name = "SpawnTweaks-ammo_starting_amount", type = "int-setting", default_value = 20, setting_type = "runtime-global", order = "0160" },
        { name = "SpawnTweaks-armor_base_multiplyer", type = "int-setting", default_value = 15, setting_type = "runtime-global", order = "0300" },
        { name = "SpawnTweaks-capsule_base_multiplyer", type = "int-setting", default_value = 50, setting_type = "runtime-global", order = "0400" },
        { name = "SpawnTweaks-capsule_starting_amount", type = "int-setting", default_value = 5, setting_type = "runtime-global", order = "0410" },
        ...
        -- startup
        { name = "SpawnTweaks-player_corpse_life", type = "int-setting", default_value = 15, setting_type = "startup", order = "0100" },
        { name = "SpawnTweaks-biter_corpse_life", type = "int-setting", default_value = 5, setting_type = "startup", order = "0200" },
        { name = "SpawnTweaks-healing_per_tick", type = "double-setting", default_value = 0.15, minimum_value = 0, setting_type = "startup", order = "0300" }, -- 9hp per second
        { name = "SpawnTweaks-ticks_to_stay_in_combat", type = "int-setting", default_value = 600, minimum_value = 0, setting_type = "startup", order = "0400" }, -- 10 seconds default
